    ...
    <div>
      {cartItems.length > 0 ? (
        <>
          ...
          <div className="flex flex-col gap-2 mt-6 md:items-end">
            <div className="flex items-center gap-1">
              <span className="font-medium">Total Items In Cart: </span>
              <strong className="text-accent">{totalItems}</strong>
            </div>
            ...
            <div className="flex items-center gap-1">
              ...
              <strong className="text-accent">{formatCurrency(5)}</strong>
            </div>
